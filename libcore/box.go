...
func NewSingBoxInstance(config string, localTransport LocalDNSTransport) (b *BoxInstance, err error) {
	...
	ctx = box.Context(ctx,
		najiboxAndroidInboundRegistry(), najiboxAndroidOutboundRegistry(), najiboxAndroidEndpointRegistry(),
		najiboxAndroidDNSTransportRegistry(localTransport), najiboxAndroidServiceRegistry(),
	)
