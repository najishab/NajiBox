...
object Action {
    const val SERVICE = "io.najishab.najibox.SERVICE"
    const val CLOSE = "io.najishab.najibox.CLOSE"
    const val RELOAD = "io.najishab.najibox.RELOAD"

    // const val SWITCH_WAKE_LOCK = "io.najishab.najibox.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "io.najishab.najibox.RESET_UPSTREAM_CONNECTIONS"
}
