...
import io.najishab.najibox.*
import io.najishab.najibox.bg.VpnService
import io.najishab.najibox.database.DataStore
import io.najishab.najibox.database.ProxyEntity
import io.najishab.najibox.database.ProxyEntity.Companion.TYPE_CONFIG
import io.najishab.najibox.database.SagerDatabase
import io.najishab.najibox.fmt.ConfigBuildResult.IndexEntity
import io.najishab.najibox.fmt.hysteria.HysteriaBean
import io.najishab.najibox.fmt.hysteria.buildSingBoxOutboundHysteriaBean
import io.najishab.najibox.fmt.internal.ChainBean
import io.najishab.najibox.fmt.shadowsocks.ShadowsocksBean
import io.najishab.najibox.fmt.shadowsocks.buildSingBoxOutboundShadowsocksBean
import io.najishab.najibox.fmt.socks.SOCKSBean
import io.najishab.najibox.fmt.socks.buildSingBoxOutboundSocksBean
import io.najishab.najibox.fmt.ssh.SSHBean
import io.najishab.najibox.fmt.ssh.buildSingBoxOutboundSSHBean
import io.najishab.najibox.fmt.tuic.TuicBean
import io.najishab.najibox.fmt.tuic.buildSingBoxOutboundTuicBean
import io.najishab.najibox.fmt.v2ray.StandardV2RayBean
import io.najishab.najibox.fmt.v2ray.buildSingBoxOutboundStandardV2RayBean
import io.najishab.najibox.fmt.wireguard.WireGuardBean
import io.najishab.najibox.fmt.wireguard.buildSingBoxOutboundWireguardBean
import io.najishab.najibox.ktx.isIpAddress
import io.najishab.najibox.ktx.mkPort
import io.najishab.najibox.utils.PackageCache
import moe.manooch.najib4x.*
import moe.manooch.najib4x.SingBoxOptions.*
import moe.manooch.najib4x.plugin.Plugins
