package io.najishab.najibox.database
...
import io.najishab.najibox.fmt.*
import io.najishab.najibox.fmt.http.HttpBean
import io.najishab.najibox.fmt.http.toUri
import io.najishab.najibox.fmt.hysteria.*
import io.najishab.najibox.fmt.internal.ChainBean
import io.najishab.najibox.fmt.mieru.MieruBean
import io.najishab.najibox.fmt.mieru.buildMieruConfig
import io.najishab.najibox.fmt.naive.NaiveBean
import io.najishab.najibox.fmt.naive.buildNaiveConfig
import io.najishab.najibox.fmt.naive.toUri
import io.najishab.najibox.fmt.shadowsocks.*
import moe.manooch.najib4x.proxy.shadowtls.ShadowTLSBean
import io.najishab.najibox.fmt.socks.SOCKSBean
import io.najishab.najibox.fmt.socks.toUri
import io.najishab.najibox.fmt.ssh.SSHBean
import io.najishab.najibox.fmt.trojan.TrojanBean
import io.najishab.najibox.fmt.trojan_go.TrojanGoBean
import io.najishab.najibox.fmt.trojan_go.buildTrojanGoConfig
import io.najishab.najibox.fmt.trojan_go.toUri
...
import moe.manooch.najib4x.proxy.anytls.toUri
