...
import io.najishab.najibox.database.preference.KeyValuePair
import io.najishab.najibox.database.preference.PublicDatabase
import io.najishab.najibox.databinding.LayoutBackupBinding
import io.najishab.najibox.databinding.LayoutImportBinding
import io.najishab.najibox.databinding.LayoutProgressBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.actionExport.setOnClickListener {
            runOnDefaultDispatcher {
                ...
                onMainDispatcher {
                    ...
                    startFilesForResult(
                        exportSettings, "najibox_backup_$date.json"
                    )
                }
            }
        }
        ...
        binding.actionShare.setOnClickListener {
            runOnDefaultDispatcher {
                ...
                val date = SimpleDateFormat("yyyy-MM-dd_HH-mm", Locale.getDefault()).format(Date())
                val cacheFile = File(
                    app.cacheDir, "najibox_backup_$date.json"
                )
