package io.najishab.najibox.group

import android.annotation.SuppressLint
import io.najishab.najibox.R
import io.najishab.najibox.database.*
...
import io.najishab.najibox.fmt.hysteria.parseHysteria1Json
import io.najishab.najibox.fmt.shadowsocks.ShadowsocksBean
import io.najishab.najibox.fmt.shadowsocks.parseShadowsocks
...
import io.najishab.najibox.fmt.v2ray.isTLS
import io.najishab.najibox.fmt.v2ray.setTLS
...
object RawUpdater : GroupUpdater() {
    ...
    override suspend fun doUpdate(
        ...
        if (link.startsWith("content://")) {
            ...
            // 修改默认名字
            if (proxyGroup.name?.startsWith("sub#") == true) {
