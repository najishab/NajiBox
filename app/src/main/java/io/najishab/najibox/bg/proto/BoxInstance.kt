...
import io.najishab.najibox.bg.AbstractInstance
...
import io.najishab.najibox.fmt.ConfigBuildResult
import io.najishab.najibox.fmt.buildConfig
import io.najishab.najibox.fmt.hysteria.HysteriaBean
import io.najishab.najibox.fmt.hysteria.buildHysteria1Config
...
abstract class BoxInstance(
    ...
    lateinit var box: libcore.BoxInstance
    ...
    override fun close() {
        ...
        if (::processes.isInitialized) processes.close(CoroutineScope(Dispatchers.IO))
