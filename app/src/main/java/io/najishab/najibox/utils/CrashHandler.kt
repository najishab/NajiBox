package io.najishab.najibox.utils
...
import io.najishab.najibox.ui.BlankActivity
...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "NajiBox for Android ${SagerNet.appVersionNameForDisplay} (${BuildConfig.VERSION_CODE})\n"
    ...
    private fun getSystemProperties(): Properties {
        ...
        try {
            ...
            while (bufferedReader.readLine().also { line = it } != null) {
                val matcher = propertiesPattern.matcher(line as CharSequence)
                if (matcher.matches()) {
