package moe.manooch.najib4x.utils
...
object Util {
    ...
    fun getPersianDate(date: Date): String {
        ...
        var days = 365 * (gy - 1600) + (gy - 1599) / 4 - (gy - 1501) / 100 + (gy - 1201) / 400 + gd - 1
        ...
        val jMonths = arrayOf("فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند")
